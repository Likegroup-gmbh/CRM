...
- [ ] 1.0 FormConfig für Marken korrigieren
...
- [ ] 2.0 MarkeDetail Edit-Modus erweitern
  - [ ] 2.1 `showEditForm()` Methode erweitern für Datenformatierung
  - [ ] 2.2 Edit-Mode Flags (_isEditMode, _entityId) hinzufügen
  - [ ] 2.3 Bestehende unternehmen_id und branche_id als vorausgewählte Werte formatieren
  - [ ] 2.4 FormSystem.bindFormEvents() mit vorbereiteten Daten aufrufen

- [ ] 3.0 DynamicDataLoader für einfache Selects im Edit-Modus erweitern
  - [ ] 3.1 Edit-Modus Erkennung für einfache Select-Felder hinzufügen
  - [ ] 3.2 Bestehende Werte als "selected" markieren für Auto-Suggestion
  - [ ] 3.3 Unternehmen und Branchen Namen für Anzeige laden
  - [ ] 3.4 Fallback-Logik für fehlende Referenzdaten implementieren

- [ ] 4.0 FormSystem Edit-Modus Integration
  - [ ] 4.1 Edit-Modus Daten aus form.dataset.editModeData lesen
  - [ ] 4.2 Auto-Suggestion Felder mit bestehenden Werten initialisieren
  - [ ] 4.3 Sicherstellen dass Änderungen korrekt erfasst werden
