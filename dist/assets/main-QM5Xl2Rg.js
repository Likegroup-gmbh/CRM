import{m as y,_ as C,c as Z}from"./modules-DoZ5_CqG.js";import{a as K,b as H,p as Se}from"./auth-8AdYCECV.js";import"./core-C7Vz5Umf.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const Ae={SUPABASE:{URL:"https://yktycclozgsgaasduyol.supabase.co",KEY:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlrdHljY2xvemdzZ2Fhc2R1eW9sIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTMwODYzNTEsImV4cCI6MjA2ODY2MjM1MX0.6TM9Td6iKgmXV_fEPMJWZiD9n--X9TeNk0FoeL5B-9c"},APP:{NAME:"CRM Dashboard",VERSION:"2.0.0",DEBUG:!1,OFFLINE_MODE:!1},AUTH:{MIN_PASSWORD_LENGTH:4,MAX_LOGIN_ATTEMPTS:3,LOCKOUT_TIME:900*1e3},UI:{THEME:"light",LANGUAGE:"de",ANIMATIONS:!0}};typeof window<"u"&&(window.CONFIG=Ae);class G{static sanitize(e){return!e||typeof e!="string"?"":this.regexSanitize(e)}static regexSanitize(e){return e.replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/\s*style\s*=\s*["'][^"']*["']/gi,"").replace(/\s*on\w+\s*=\s*["'][^"']*["']/gi,"").replace(/<(iframe|object|embed|form|input|style)[^>]*>[\s\S]*?<\/\1>/gi,"").replace(/<(?!\/?(?:p|br|strong|em|a|ul|ol|li|span|div)\b)[^>]+>/gi,"")}static setContent(e,t){e&&(e.innerHTML=this.sanitize(t))}static setText(e,t){e&&(e.textContent=t)}static escapeHtml(e){if(!e||typeof e!="string")return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}static createSafeElement(e,t,n={}){const a=document.createElement(e);t&&(a.textContent=t);for(const[r,i]of Object.entries(n))if(r==="class")a.className=i;else if(r==="href"&&e==="a")try{const s=new URL(i,window.location.origin);(s.protocol==="http:"||s.protocol==="https:")&&(a.href=s.href)}catch{console.warn("Ungültige URL ignoriert:",i)}else a.setAttribute(r,i);return a}}typeof window<"u"&&(window.SafeHTML=G);class M{static hide(e){e&&e.classList.add("hidden")}static show(e){e&&e.classList.remove("hidden")}static toggle(e){e&&(e.classList.contains("hidden")?this.show(e):this.hide(e))}static hideAll(e){e.forEach(t=>this.hide(t))}static showAll(e){e.forEach(t=>this.show(t))}static setVisibility(e,t){e&&(t?this.show(e):this.hide(e))}static setDisplay(e,t){if(!e)return;const n=t!=="none"&&t!=="";this.setVisibility(e,n)}}window.DOMHelper=M;class De{constructor(){this.dropdowns=new Map,this.boundEventListeners=new Set,this._iconObserver=null,this._normalizingIcons=!1}init(){console.log("🎯 ACTIONSDROPDOWN: Initialisiere ActionsDropdown"),this.bindGlobalEvents(),this.normalizeIcons(document),this.observeTableMutations(),setTimeout(()=>{console.log("🔍 ACTIONSDROPDOWN: Debug - Überprüfe Initialisierung"),console.log("🔍 ACTIONSDROPDOWN: window.ActionsDropdown verfügbar:",!!window.ActionsDropdown),console.log("🔍 ACTIONSDROPDOWN: createAuftragActions verfügbar:",!!window.ActionsDropdown?.createAuftragActions)},1e3)}getHeroIcon(e){switch(e){case"view":return`
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
    ...
    `}handleAction(e,t,n,a){switch(console.log(`🎯 ACTIONSDROPDOWN: Action ${e} für ${n} ${t}`),e){case"view":window.navigateTo(`/${n}/${t}`);break;case"edit":window.navigateTo(`/${n}/${t}/edit`);break;case"delete":this.confirmDelete(t,n);break;case"notiz":this.openNotizModal(t,n);break;case"rating":this.openRatingModal(t,n);break;case"marken":window.navigateTo(`/unternehmen/${t}/marken`);break;case"auftraege":window.navigateTo(`/unternehmen/${t}/auftraege`);break;case"kampagnen":window.navigateTo(`/auftrag/${t}/kampagnen`);break;case"quickview":this.openKooperationQuickView(t);break;case"assign-staff":if(window.currentUser?.rolle!=="admin"){alert("Nur Admins dürfen Mitarbeiter zuordnen.");break}this.openAssignStaffModal(t);break;case"rechnung":this.openRechnungModal(t,n);break;case"invoice-view":window.navigateTo(`/rechnung/${t}`);break;case"invoice-edit":window.navigateTo(`/rechnung/${t}/edit`);break;case"add_to_campaign":this.openAddToCampaignModal(t);break;case"favorite":{const r=document.querySelector("[data-kampagne-id]")?.dataset?.kampagneId;this.addToFavorites(t,r);break}case"add_to_list":{this.openAddToListModal(t);break}case"add_ansprechpartner":{this.openAddAnsprechpartnerModal(t);break}case"add_ansprechpartner_kampagne":{this.openAddAnsprechpartnerToKampagneModal(t);break}case"unassign-kampagne":{const r=a?.dataset?.mitarbeiterId||window.location.pathname.split("/").pop();if(!r){alert("Mitarbeiter-ID nicht gefunden");break}const i=t;if(!i||!confirm("Zuweisung dieser Kampagne vom Mitarbeiter entfernen?"))break;(async()=>{try{const{error:s}=await window.supabase.from("kampagne_mitarbeiter").delete().eq("mitarbeiter_id",r).eq("kampagne_id",i);if(s)throw s;const o=a.closest("tr");o&&o.remove();const l=document.querySelector('.tab-button[data-tab="kampagnen"] .tab-count');if(l){const c=parseInt(l.textContent||"1",10);l.textContent=String(Math.max(0,c-1))}alert("Zuweisung entfernt")}catch(s){console.error("❌ Zuweisung entfernen fehlgeschlagen",s),alert("Entfernen fehlgeschlagen")}})();break}case"video-view":window.navigateTo(`/video/${t}`);break;case"video-edit":window.navigateTo(`/video/${t}`);break;case"video-delete":this.confirmDelete(t,"kooperation_videos");break;default:console.warn(`⚠️ Unbekannte Action: ${e}`)}}async openKooperationQuickView(e){try{const t=document.createElement("div");t.className="drawer-overlay";const n=document.createElement("div");n.setAttribute("role","dialog"),n.className="drawer-panel";const a=document.createElement("div");a.className="drawer-header";const r=document.createElement("div"),i=document.createElement("h1");i.textContent="Kooperation · Schnellansicht";const s=document.createElement("p");s.style.margin="0",s.style.color="#6b7280",s.textContent="Videos & Kommentare",r.appendChild(i),r.appendChild(s);const o=document.createElement("div"),l=document.createElement("button");l.className="drawer-close",l.id="kvq-close",l.textContent="Schließen",o.appendChild(l),a.appendChild(r),a.appendChild(o);const c=document.createElement("div");c.className="drawer-body";const d=document.createElement("div");d.className="detail-section";const u=document.createElement("h2");u.textContent="Videos";const h=document.createElement("div");h.id="kvq-table",h.textContent="Lade...",d.appendChild(u),d.appendChild(h),c.replaceChildren(d),n.appendChild(a),n.appendChild(c),document.body.appendChild(t),document.body.appendChild(n);const m=()=>{try{t.remove(),n.remove()}catch{}};t.addEventListener("click",m),a.querySelector("#kvq-close")?.addEventListener("click",m),document.addEventListener("keydown",function _(L){L.key==="Escape"&&(m(),document.removeEventListener("keydown",_))}),requestAnimationFrame(()=>{n.classList.add("show")});const{data:g}=await window.supabase.from("kooperation_videos").select("id, position, content_art, titel, asset_url, status, created_at").eq("kooperation_id",e).order("position",{ascending:!0}),b=g||[];let f={};if(b.length){const _=b.map(F=>F.id),{data:L}=await window.supabase.from("kooperation_video_comment").select("id, video_id, runde, text, author_name, created_at").in("video_id",_).order("created_at",{ascending:!0});(L||[]).forEach(F=>{const I=F.video_id;f[I]||(f[I]={r1:[],r2:[]});const N=F.runde===2||F.runde==="2"?"r2":"r1";f[I][N].push(F)})}const v=_=>window.validatorSystem?.sanitizeHtml?.(_)??_,w=_=>_?new Date(_).toLocaleDateString("de-DE"):"-",k=_=>!_||!_.length?"-":_.map(L=>{const F=v(L.text||""),I=v(L.author_name||"-"),N=w(L.created_at);return`<div class="fb-line"><span class="fb-meta">${I} • ${N}</span><div class="fb-text">${F}</div></div>`}).join(""),E=b.map(_=>{const L=f[_.id]||{r1:[],r2:[]},F=_.asset_url?`<a class="kvq-link-btn" href="${_.asset_url}" target="_blank" rel="noopener">${this.getHeroIcon("view")}<span>Öffnen</span></a>`:"-";return`
        ...
        </div>`:'<p class="empty-state">Keine Videos vorhanden.</p>',A=c.querySelector("#kvq-table");if(A.innerHTML="",b.length){const _=document.createElement("div");_.className="data-table-container",_.innerHTML=$,A.appendChild(_)}else{const _=document.createElement("p");_.className="empty-state",_.textContent="Keine Videos vorhanden.",A.appendChild(_)}this.normalizeIcons(c)}catch(t){console.error("❌ Quickview öffnen fehlgeschlagen",t),alert("Schnellansicht konnte nicht geöffnet werden.")}}async openAssignStaffModal(e){const t=document.createElement("div");t.className="modal overlay-modal",t.innerHTML=`
      ...
      </div>`,document.body.appendChild(a);const r=a.querySelector("#ansprechpartner-search"),i=a.querySelector("#ansprechpartner-dropdown");let s=null;const o=(u="")=>{if(!u||u.trim().length===0){i.innerHTML='<div class="dropdown-item no-results">Beginnen Sie zu tippen, um Ansprechpartner zu suchen...</div>';return}const h=u.toLowerCase(),m=t.filter(g=>{const b=`${g.vorname} ${g.nachname}`.toLowerCase(),f=(g.email||"").toLowerCase(),v=(g.unternehmen?.firmenname||"").toLowerCase();return b.includes(h)||f.includes(h)||v.includes(h)});i.innerHTML=m.length?m.map(g=>{const b=`${g.vorname} ${g.nachname}`,f=[g.email,g.unternehmen?.firmenname,g.position?.name].filter(Boolean).join(" • ");return`<div class="dropdown-item" data-id="${g.id}">
              <div class="dropdown-item-main">${b}</div>
    ...
    `).join(""),D.normalizeIcons(document)}destroy(){}}const ze=new Le;function Fe(p,e={}){const{showActions:t=!1}=e,n=i=>i?new Date(i).toLocaleDateString("de-DE"):"-",a=i=>Array.isArray(i)&&i.length>0?i.join(", "):"-",r=(p||[]).map(i=>{const s=i.id,o=i.kampagnenname||"Unbekannt",l=i.unternehmen?.firmenname||"-",c=i.marke?.markenname||"-",d=a(i.art_der_kampagne),u=i.status||"-",h=n(i.start),m=n(i.deadline),g=i.creatoranzahl??"-",b=i.videoanzahl??"-";return`
      <tr data-id="${s||""}">
        <td>
  ...
  `}class Me{constructor(){this.creatorId=null,this.creator=null,this.notizen=[],this.ratings=[],this.kampagnen=[],this.lists=[],this.kooperationen=[],this.rechnungen=[]}async init(e){if(console.log("🎯 CREATORDETAIL: Initialisiere Creator-Detailseite für ID:",e),this.creatorId=e,window.moduleRegistry?.currentModule!==this){console.log("⚠️ CREATORDETAIL: Nicht mehr das aktuelle Modul, breche ab");return}try{await this.loadCreatorData(),await this.render(),this.bindEvents(),console.log("✅ CREATORDETAIL: Initialisierung abgeschlossen")}catch(t){console.error("❌ CREATORDETAIL: Fehler bei der Initialisierung:",t),window.ErrorHandler.handle(t,"CreatorDetail.init")}}async loadCreatorData(){console.log("🔄 CREATORDETAIL: Lade Creator-Daten...");const{data:e,error:t}=await window.supabase.from("creator").select("*").eq("id",this.creatorId).single();if(t)throw new Error(`Fehler beim Laden der Creator-Daten: ${t.message}`);this.creator=e,console.log("✅ CREATORDETAIL: Creator-Basisdaten geladen:",e);try{const{data:s}=await window.supabase.from("creator_sprachen").select("sprache_id, sprachen:sprache_id(id, name)").eq("creator_id",this.creatorId);this.creator.sprachen=(s||[]).map(o=>o.sprachen).filter(Boolean)}catch{}try{const{data:s}=await window.supabase.from("creator_branchen").select("branche_id, branchen_creator:branche_id(id, name)").eq("creator_id",this.creatorId);this.creator.branchen=(s||[]).map(o=>o.branchen_creator).filter(Boolean)}catch{}try{const{data:s}=await window.supabase.from("creator_creator_type").select("creator_type_id, creator_type:creator_type_id(id, name)").eq("creator_id",this.creatorId);this.creator.creator_types=(s||[]).map(o=>o.creator_type).filter(Boolean)}catch{}this.notizen=await window.notizenSystem.loadNotizen("creator",this.creatorId),console.log("✅ CREATORDETAIL: Notizen geladen:",this.notizen.length),this.ratings=await window.bewertungsSystem.loadBewertungen("creator",this.creatorId),console.log("✅ CREATORDETAIL: Ratings geladen:",this.ratings.length);const{data:n,error:a}=await window.supabase.from("kampagne_creator").select(`
    ...
    `;window.setContentSafely(window.content,e)}renderTagList(e){if(!e||e.length===0)return"-";if(Array.isArray(e))return`<div class="tags">${e.map(n=>{const a=typeof n=="object"&&(n.name||n.label)||n;return`<span class="tag">${String(a).trim()}</span>`}).join("")}</div>`;if(typeof e=="object"){const t=e.name||e.label;return t?`<div class="tags"><span class="tag">${t}</span></div>`:"-"}return`<div class="tags"><span class="tag">${String(e)}</span></div>`}renderNotizen(){return window.notizenSystem.renderNotizenContainer(this.notizen,"creator",this.creatorId)}renderRatings(){return window.bewertungsSystem.renderBewertungenContainer(this.ratings,"creator",this.creatorId)}renderKampagnen(){if(!this.kampagnen||this.kampagnen.length===0)return`
      ...
      `;const e=this.kampagnen.map(t=>{const n=t.kampagne||t;return{id:n.id,kampagnenname:n.kampagnenname,unternehmen:n.unternehmen||null,marke:n.marke||null,art_der_kampagne:n.art_der_kampagne,status:n.status,start:n.start,deadline:n.deadline,creatoranzahl:n.creatoranzahl,videoanzahl:n.videoanzahl}});return Fe(e,{showActions:!1})}renderLists(){return this.lists.length===0?`
        <div class="empty-state">
    ...
    `}destroy(){}}const Be=new Te;class Ce{constructor(){this.selectedUnternehmen=new Set,this._boundEventListeners=new Set}async init(){if(window.setHeadline("Unternehmen Übersicht"),!(window.canViewPage&&window.canViewPage("unternehmen")||await window.checkUserPermission("unternehmen","can_view"))){window.content.innerHTML=`
        <div class="error-message">
          <p>Sie haben keine Berechtigung, Unternehmen anzuzeigen.</p>
        </div>
      `;return}this.bindEvents(),await this.loadAndRender()}async loadAndRender(){try{const e=await window.dataService.loadFilterData("unternehmen");await this.render(e);const t=y.getFilters("unternehmen");console.log("🔍 Lade Unternehmen mit Filter:",t);const n=await window.dataService.loadEntities("unternehmen",t);console.log("📊 Unternehmen geladen:",n?.length||0),this.updateTable(n)}catch(e){window.ErrorHandler.handle(e,"UnternehmenList.loadAndRender")}}async render(e){const t=window.currentUser?.permissions?.unternehmen?.can_edit||!1,n=y.getFilters("unternehmen");Object.entries(n).forEach(([i,s])=>{});let a=`<div class="filter-bar">
    ...
    `;window.setContentSafely(window.content,r),await this.initializeFilterBar()}async initializeFilterBar(){const e=document.getElementById("filter-container");e&&await y.renderFilterBar("unternehmen",e,t=>this.onFiltersApplied(t),()=>this.onFiltersReset())}onFiltersApplied(e){console.log("Filter angewendet:",e),y.applyFilters("unternehmen",e),this.loadAndRender()}onFiltersReset(){console.log("Filter zurückgesetzt"),y.resetFilters("unternehmen"),this.loadAndRender()}bindEvents(){this.boundFilterResetHandler=e=>{e.target.id==="btn-filter-reset"&&this.onFiltersReset()},document.addEventListener("click",this.boundFilterResetHandler),document.addEventListener("click",e=>{(e.target.id==="btn-unternehmen-new"||e.target.id==="btn-unternehmen-new-filter")&&(e.preventDefault(),window.navigateTo("/unternehmen/new"))}),document.addEventListener("click",e=>{if(e.target.classList.contains("table-link")&&e.target.dataset.table==="unternehmen"){e.preventDefault();const t=e.target.dataset.id;console.log("🎯 UNTERNEHMENLIST: Navigiere zu Unternehmen Details:",t),window.navigateTo(`/unternehmen/${t}`)}}),document.addEventListener("click",e=>{if(e.target.id==="btn-select-all"){e.preventDefault(),document.querySelectorAll(".unternehmen-check").forEach(a=>{a.checked=!0,a.dataset.id&&this.selectedUnternehmen.add(a.dataset.id)});const n=document.getElementById("select-all-unternehmen");n&&(n.indeterminate=!1,n.checked=!0),this.updateSelection()}}),document.addEventListener("click",e=>{e.target.id==="btn-deselect-all"&&(e.preventDefault(),this.deselectAll())}),window.addEventListener("entityUpdated",e=>{e.detail.entity==="unternehmen"&&this.loadAndRender()}),document.addEventListener("click",e=>{if(e.target.classList.contains("tag-x")){e.preventDefault(),e.stopPropagation();const n=e.target.closest(".filter-tag").dataset.key,a=y.getFilters("unternehmen");delete a[n],y.applyFilters("unternehmen",a),this.loadAndRender()}}),document.addEventListener("change",e=>{if(e.target.id==="select-all-unternehmen"){const t=document.querySelectorAll(".unternehmen-check"),n=e.target.checked;t.forEach(a=>{a.checked=n,n?this.selectedUnternehmen.add(a.dataset.id):this.selectedUnternehmen.delete(a.dataset.id)}),this.updateSelection(),console.log(`${n?"✅ Alle Unternehmen ausgewählt":"❌ Alle Unternehmen abgewählt"}: ${this.selectedUnternehmen.size}`)}}),document.addEventListener("change",e=>{e.target.classList.contains("unternehmen-check")&&(e.target.checked?this.selectedUnternehmen.add(e.target.dataset.id):this.selectedUnternehmen.delete(e.target.dataset.id),this.updateSelection(),this.updateSelectAllCheckbox())}),window.bulkActionSystem&&window.bulkActionSystem.registerList("unternehmen",this)}hasActiveFilters(){const e=y.getFilters("unternehmen");return Object.keys(e).length>0}updateSelection(){const e=this.selectedUnternehmen.size,t=document.getElementById("selected-count"),n=document.getElementById("btn-deselect-all"),a=document.getElementById("btn-delete-selected");t&&(t.textContent=`${e} ausgewählt`,t.style.display=e>0?"inline":"none"),n&&(n.style.display=e>0?"inline-block":"none"),a&&(a.style.display=e>0?"inline-block":"none")}async updateTable(e){const t=document.querySelector(".data-table tbody");if(!t)return;if(!e||e.length===0){const{renderEmptyState:i}=await C(async()=>{const{renderEmptyState:s}=await import("./core-C7Vz5Umf.js").then(o=>o.F);return{renderEmptyState:s}},[]);i(t);return}const n=e.map(i=>i.id).filter(Boolean),a=await this.loadAnsprechpartnerMap(n),r=e.map(i=>`
      <tr data-id="${i.id}">
...
${a} Aufträge konnten nicht gelöscht werden.`):alert(i),r.forEach(o=>{const l=document.querySelector(`tr[data-id="${o}"]`);l&&l.remove()}),this.selectedAuftraege.clear(),this.updateSelection(),this.updateSelectAllCheckbox();const s=document.getElementById("auftraege-table-body");s&&s.children.length===0&&await this.loadAndRender(),window.dispatchEvent(new CustomEvent("entityUpdated",{detail:{entity:"auftrag",action:"bulk-deleted",count:n}}))}else alert("Keine Aufträge konnten gelöscht werden.")}}const Q=new xe;class Ne{constructor(){this.formData={}}async init(){console.log("🎯 MARKECREATE: Initialisiere Marke-Erstellung"),this.showCreateForm()}showCreateForm(){console.log("🎯 MARKECREATE: Zeige Marke-Erstellungsformular mit FormSystem"),window.setHeadline("Neue Marke anlegen");const e=window.formSystem.renderFormOnly("marke");window.content.innerHTML=`
    ...
    `).join("");t.innerHTML=n}renderBranchen(e){return!e||e.length===0?"-":`<div class="tags tags-compact">${e.filter(n=>n&&n.name).map(n=>`<span class="tag tag--branche">${n.name}</span>`).join("")}</div>`}renderAnsprechpartner(e){return!e||e.length===0?"-":`<div class="tags tags-compact">${e.filter(n=>n&&n.vorname&&n.nachname).map(n=>`<a href="#" class="tag tag--ansprechpartner" data-action="view-ansprechpartner" data-id="${n.id}" onclick="event.preventDefault(); window.navigateTo('/ansprechpartner/${n.id}')">${n.vorname} ${n.nachname}</a>`).join("")}</div>`}renderZustaendigkeit(e){return!e||e.length===0?"-":Array.isArray(e)?e.map(t=>`${t.mitarbeiter?.name||"Unbekannt"}`).join(", "):e.mitarbeiter?.name||"Unbekannt"}destroy(){console.log("🗑️ MARKELLIST: Destroy aufgerufen"),this._boundEventListeners.forEach(({element:e,type:t,handler:n})=>{e.removeEventListener(t,n)}),this._boundEventListeners.clear(),this.boundFilterResetHandler&&(document.removeEventListener("click",this.boundFilterResetHandler),this.boundFilterResetHandler=null),window.setContentSafely(""),console.log("✅ MARKELLIST: Destroy abgeschlossen")}showDeleteSelectedConfirmation(){const e=this.selectedMarken.size;if(console.log(`🔧 MarkeList: showDeleteSelectedConfirmation aufgerufen, selectedCount: ${e}`,Array.from(this.selectedMarken)),e===0){alert("Keine Marken ausgewählt.");return}const t=e===1?"Möchten Sie die ausgewählte Marke wirklich löschen?":`Möchten Sie die ${e} ausgewählten Marken wirklich löschen?`;confirm(`${t}
...
${a} Marken konnten nicht gelöscht werden.`):alert(i),r.forEach(o=>{const l=document.querySelector(`tr[data-id="${o}"]`);l&&l.remove()}),this.selectedMarken.clear(),this.updateSelection(),this.updateSelectAllCheckbox();const s=document.getElementById("marken-table-body");s&&s.children.length===0&&await this.loadAndRender(),window.dispatchEvent(new CustomEvent("entityUpdated",{detail:{entity:"marke",action:"bulk-deleted",count:n}}))}else alert("Keine Marken konnten gelöscht werden.")}showCreateForm(){console.log("🎯 Zeige Marken-Erstellungsformular mit MarkeCreate"),U.showCreateForm()}}const X=new Re;class Ke{constructor(){this.markeId=null,this.marke=null,this.notizen=[],this.ratings=[],this.kampagnen=[],this.auftraege=[],this.ansprechpartner=[],this.rechnungen=[]}async init(e){console.log("🎯 MARKENDETAIL: Initialisiere Marken-Detailseite für ID:",e);try{this.markeId=e,await this.loadMarkeData(),this.render(),this.bindEvents(),console.log("✅ MARKENDETAIL: Initialisierung abgeschlossen")}catch(t){console.error("❌ MARKENDETAIL: Fehler bei der Initialisierung:",t),window.ErrorHandler.handle(t,"MarkeDetail.init")}}async loadMarkeData(){console.log("🔄 MARKENDETAIL: Lade Marken-Daten...");try{const{data:e,error:t}=await window.supabase.from("marke").select(`
    ...
    `).join("");this.listEl.innerHTML=e,this.listEl.querySelectorAll(".uploader-remove").forEach(t=>{t.addEventListener("click",()=>{const n=parseInt(t.dataset.index,10);this.files.splice(n,1),this.renderList(),this.onFilesChanged(this.files)})})}formatSize(e){if(!e&&e!==0)return"";const t=["B","KB","MB","GB"];let n=e,a=0;for(;n>=1024&&a<t.length-1;)n/=1024,a++;return`${n.toFixed(1)} ${t[a]}`}}class re{constructor(){this.validator=new ne}getFieldLabel(e){return{unternehmen_id:"Unternehmen",marke_id:"Marke",auftrag_id:"Auftrag",kampagne_id:"Kampagne",creator_id:"Creator"}[e]||e}renderForm(e,t=null){const n=this.getFormConfig(e);if(!n)return console.error(`❌ Keine Konfiguration für Entity: ${e}`),"";const a=!!t,r=this.renderFormOnly(e,t);return`
      <div class="modal-header">
    ...
    `}renderField(e,t=""){const n=`field-${e.name}`,a=e.required?"required":"",r=e.required?'<span class="required">*</span>':"";switch(e.type){case"text":case"email":case"tel":case"url":const i=e.dependsOn?`data-depends-on="${e.dependsOn}"`:"",s=e.showWhen?`data-show-when="${e.showWhen}"`:"",o=e.autoGenerate?'data-auto-generate="true"':"",l=e.readonly?"readonly":"",c=e.placeholder?`placeholder="${e.placeholder}"`:"",d=e.dependsOn?'style="display: none;"':"";return`
        ...
        `;case"number":const u=e.readonly?"readonly":"",h=e.autoCalculate?'data-auto-calculate="true"':"",m=e.calculatedFrom?`data-calculated-from="${e.calculatedFrom.join(",")}"`:"",g=e.placeholder?`placeholder="${e.placeholder}"`:"",b=e.validation?.min!==void 0?`min="${e.validation.min}"`:"",f=e.validation?.max!==void 0?`max="${e.validation.max}"`:"",v=e.validation?.step!==void 0?`step="${e.validation.step}"`:'step="0.01"',w=e.defaultValue!==void 0&&(t===""||t===void 0||t===null)?`value="${e.defaultValue}"`:`value="${t}"`;return`
          <div class="form-field">
            <label for="${n}">${e.label} ${r}</label>
            <input type="number" id="${n}" name="${e.name}" ${w} ${a} ${u} ${h} ${m} ${g} ${b} ${f} ${v}>
        ...
        `;case"textarea":const k=e.dependsOn?`data-depends-on="${e.dependsOn}"`:"",E=e.showWhen?`data-show-when="${e.showWhen}"`:"";return`
          <div class="form-field form-field-full" ${k} ${E}>
            <label for="${n}">${e.label} ${r}</label>
            <textarea id="${n}" name="${e.name}" rows="4" ${a}>${this.validator.sanitizeHtml(t)}</textarea>
          </div>
        `;case"select":let $="";if(e.dynamic?$=`<option value="">${e.dependsOn?`Erst ${this.getFieldLabel(e.dependsOn)} auswählen...`:e.placeholder||"Bitte wählen..."}</option>`:$=e.options.map(z=>`<option value="${z}" ${t===z?"selected":""}>${z}</option>`).join(""),e.searchable){const z=e.dependsOn?"disabled":"",B=e.readonly?"disabled":z,j=e.dependsOn?`Erst ${this.getFieldLabel(e.dependsOn)} auswählen...`:e.placeholder||"Bitte wählen...";return`
            <div class="form-field">
              <label for="${n}">${e.label} ${r}</label>
              <select id="${n}" name="${e.name}" ${a} ${B} data-searchable="true" data-placeholder="${j}" ${e.readonly?'data-readonly="true"':""}>
                ${$}
              </select>
              ${e.readonly?`<input type="hidden" name="${e.name}" id="${n}-hidden" value="">`:""}
            </div>
          `}const A=e.dependsOn?"disabled":"",_=e.readonly?"disabled":A;return`
          <div class="form-field">
            <label for="${n}">${e.label} ${r}</label>
            <select id="${n}" name="${e.name}" ${a} ${_} ${e.readonly?'data-readonly="true"':""}>
              ${$}
            </select>
            ${e.readonly?`<input type="hidden" name="${e.name}" id="${n}-hidden" value="">`:""}
          </div>
        `;case"multiselect":const L=Array.isArray(t)?t:t?t.split(","):[];let F="";if(e.dynamic||(F=e.options.map(z=>{const B=L.includes(z)?"selected":"";return`<option value="${z}" ${B}>${z}</option>`}).join("")),e.searchable){const z=L.length>0?`data-existing-values='${JSON.stringify(L)}'`:"";return`
            <div class="form-field">
              <label for="${n}">${e.label} ${r}</label>
              <select id="${n}" name="${e.name}" ${a} multiple data-searchable="true" data-tag-based="${e.tagBased||"false"}" data-placeholder="${e.placeholder||"Bitte wählen..."}" ${z}>
                ${F}
              </select>
            </div>
          `}return`
        ...
        `;case"checkbox":const I=t==="on"||t===!0||t==="true"?"checked":"";return`
          <div class="form-field">
        ...
        `;case"toggle":const N=t==="on"||t===!0||t==="true"||t===1?"checked":"";return`
          <div class="form-field">
            <label class="toggle-container">
              <span>${e.label} ${r}</span>
              <div class="toggle-switch">
                <input type="checkbox" id="${n}" name="${e.name}" ${N} ${a}>
                <span class="toggle-slider"></span>
              </div>
            </label>
          </div>
        `;case"custom":if(e.customType==="addresses")return this.renderAddressesField(e,t);if(e.customType==="videos")return this.renderVideosField(e,t);if(e.customType==="file"){const z=e.accept?`accept="${e.accept}"`:"",B=e.multiple?"multiple":"";return`
            <div class="form-field">
              <label for="${n}">${e.label} ${r}</label>
              <input type="file" id="${n}" name="${e.name}" ${a} ${z} ${B}>
            </div>
          `}if(e.customType==="uploader"){const z=`uploader-${e.name}-${Math.random().toString(36).slice(2)}`;return setTimeout(()=>{const B=document.getElementById(z);B&&new Oe({multiple:!!e.multiple,accept:e.accept||"*/*"}).mount(B.querySelector(".uploader"))},0),`
            <div class="form-field" id="${z}">
...
${t}`)}showSuccessMessage(e){console.log(`✅ ${e}`)}showErrorMessage(e){console.error(`❌ ${e}`),alert(e)}};const de=new Ze;typeof window<"u"&&(window.formSystem=de);class Ge{constructor(){this.currentEntity=null,this.currentEntityId=null}async init(e,t){console.log("📝 NOTIZENSYSTEM: Initialisiere für",e,t),this.currentEntity=e,this.currentEntityId=t}async loadNotizen(e,t){console.log("🔄 NOTIZENSYSTEM: Lade Notizen für",e,t);try{const n=this.getNotizenTable(e);if(!n)return console.warn("⚠️ NOTIZENSYSTEM: Keine Notizen-Tabelle für",e),[];let a="*";n==="creator_notiz"&&(a+=`,
  ...
  `}class Qe{constructor(){this.unternehmenId=null,this.unternehmen=null,this.notizen=[],this.ratings=[],this.marken=[],this.auftraege=[],this.ansprechpartner=[],this.kampagnen=[],this.kooperationen=[],this.creators=[],this.rechnungen=[],this._creatorMap={}}async init(e){console.log("🎯 UNTERNEHMENDETAIL: Initialisiere Unternehmen-Detailseite für ID:",e);try{this.unternehmenId=e,await this.loadUnternehmenData(),this.render(),this.bindEvents(),console.log("✅ UNTERNEHMENDETAIL: Initialisierung abgeschlossen")}catch(t){console.error("❌ UNTERNEHMENDETAIL: Fehler bei der Initialisierung:",t),window.ErrorHandler.handle(t,"UnternehmenDetail.init")}}async loadUnternehmenData(){console.log("🔄 UNTERNEHMENDETAIL: Lade Unternehmen-Daten...");try{const{data:e,error:t}=await window.supabase.from("unternehmen").select("*").eq("id",this.unternehmenId).single();if(t)throw t;this.unternehmen=e,console.log("✅ UNTERNEHMENDETAIL: Unternehmen-Basisdaten geladen:",this.unternehmen);try{const{data:l,error:c}=await window.supabase.from("unternehmen_branchen").select(`
    ...
    `).join("")}</div>`}renderCreators(){return!this.creators||this.creators.length===0?`
      ...
      `:R(this.creators)}renderAnsprechpartner(){return!this.ansprechpartner||this.ansprechpartner.length===0?`
        <div class="empty-state">
          <div class="empty-icon">👥</div>
          <h3>Keine Ansprechpartner vorhanden</h3>
    ...
    `;window.setContentSafely(window.content,r)}async initializeFilterBar(){const e=document.getElementById("filter-container");e&&await y.renderFilterBar("kooperation",e,t=>this.onFiltersApplied(t),()=>this.onFiltersReset())}onFiltersApplied(e){console.log("🔍 KooperationList: Filter angewendet:",e),y.applyFilters("kooperation",e),this.loadAndRender()}onFiltersReset(){console.log("🔄 KooperationList: Filter zurückgesetzt"),y.resetFilters("kooperation"),this.loadAndRender()}bindEvents(){this.boundFilterResetHandler=e=>{e.target.id==="btn-filter-reset"&&this.onFiltersReset()},document.addEventListener("click",this.boundFilterResetHandler),document.addEventListener("click",e=>{(e.target.id==="btn-kooperation-new"||e.target.id==="btn-kooperation-new-filter")&&(e.preventDefault(),window.navigateTo("/kooperation/new"))}),document.addEventListener("click",e=>{if(e.target.id==="btn-select-all"){e.preventDefault(),document.querySelectorAll(".kooperation-check").forEach(a=>{a.checked=!0,a.dataset.id&&this.selectedKooperation.add(a.dataset.id)});const n=document.getElementById("select-all-kooperationen");n&&(n.indeterminate=!1,n.checked=!0),this.updateSelection()}}),document.addEventListener("click",e=>{if(e.target.id==="btn-deselect-all"){e.preventDefault(),document.querySelectorAll(".kooperation-check").forEach(a=>{a.checked=!1}),this.selectedKooperation.clear();const n=document.getElementById("select-all-kooperationen");n&&(n.indeterminate=!1,n.checked=!1),this.updateSelection()}}),document.addEventListener("click",e=>{if(e.target.classList.contains("table-link")&&e.target.dataset.table==="kooperation"){e.preventDefault();const t=e.target.dataset.id;console.log("🎯 KOOPERATIONLIST: Navigiere zu Kooperation Details:",t),window.navigateTo(`/kooperation/${t}`)}}),window.addEventListener("entityUpdated",e=>{e.detail.entity==="kooperation"&&this.loadAndRender()}),document.addEventListener("click",e=>{if(e.target.classList.contains("tag-x")){e.preventDefault(),e.stopPropagation();const n=e.target.closest(".filter-tag").dataset.key,a=y.getFilters("kooperation");delete a[n],y.applyFilters("kooperation",a),this.loadAndRender()}}),document.addEventListener("change",e=>{e.target.id==="select-all-kooperationen"&&(document.querySelectorAll(".kooperation-check").forEach(n=>{n.checked=e.target.checked,e.target.checked?this.selectedKooperation.add(n.dataset.id):this.selectedKooperation.delete(n.dataset.id)}),this.updateSelection())}),document.addEventListener("change",e=>{e.target.classList.contains("kooperation-check")&&(e.target.checked?this.selectedKooperation.add(e.target.dataset.id):this.selectedKooperation.delete(e.target.dataset.id),this.updateSelection())})}hasActiveFilters(){const e=y.getFilters("kooperation");return Object.keys(e).length>0}updateSelection(){const e=this.selectedKooperation.size,t=document.getElementById("selected-count"),n=document.getElementById("btn-deselect-all"),a=document.getElementById("btn-delete-selected");t&&(t.textContent=`${e} ausgewählt`,t.style.display=e>0?"inline":"none"),n&&(n.style.display=e>0?"inline-block":"none"),a&&(a.style.display=e>0?"inline-block":"none")}async updateTable(e){const t=document.getElementById("kooperationen-table-body");if(!t)return;if(!e||e.length===0){const{renderEmptyState:a}=await C(async()=>{const{renderEmptyState:r}=await import("./core-C7Vz5Umf.js").then(i=>i.F);return{renderEmptyState:r}},[]);a(t);return}const n=e.map(a=>{const r=s=>s?new Intl.NumberFormat("de-DE",{style:"currency",currency:"EUR"}).format(s):"-",i=s=>s?new Date(s).toLocaleDateString("de-DE"):"-";return`
        <tr data-id="${a.id}">
            ...
            <div class="actions-dropdown-container" data-entity-type="kooperation">
              ...
              <div class="actions-dropdown">
                <div class="action-submenu">
                  <a href="#" class="action-item has-submenu" data-submenu="status">${D.getHeroIcon("invoice")}<span>Status ändern</span></a>
                  <div class="submenu" data-submenu="status">
                    ${(this.statusOptions||[]).map(s=>`
                      <a href="#" class="submenu-item" data-action="set-field" data-field="status_id" data-value="${s.id}" data-status-name="${s.name.replace(/\"/g,'\\"')}" data-id="${a.id}">${D.getStatusIcon(s.name)}<span>${s.name}</span>${a.status_id===s.id||a.status===s.name?'<span class=\\"submenu-check\\">'+D.getHeroIcon("check")+"</span>":""}</a>
                    `).join("")}
                  </div>
                </div>
                <a href="#" class="action-item" data-action="view" data-id="${a.id}">
    ...
    `;window.setContentSafely(window.content,r)}async initializeFilterBar(){const e=document.getElementById("filter-container");e&&await y.renderFilterBar("kampagne",e,t=>this.onFiltersApplied(t),()=>this.onFiltersReset())}onFiltersApplied(e){console.log("🔍 KampagneList: Filter angewendet:",e),y.applyFilters("kampagne",e),this.loadAndRender()}onFiltersReset(){console.log("🔄 KampagneList: Filter zurückgesetzt"),y.resetFilters("kampagne"),this.loadAndRender()}bindEvents(){this.boundFilterResetHandler=e=>{e.target.id==="btn-filter-reset"&&this.onFiltersReset()},document.addEventListener("click",this.boundFilterResetHandler),document.addEventListener("click",e=>{(e.target.id==="btn-kampagne-new"||e.target.id==="btn-kampagne-new-filter")&&(e.preventDefault(),window.navigateTo("/kampagne/new"))}),document.addEventListener("click",e=>{if(e.target.id==="btn-select-all"){e.preventDefault(),document.querySelectorAll(".kampagne-check").forEach(a=>{a.checked=!0,a.dataset.id&&this.selectedKampagnen.add(a.dataset.id)});const n=document.getElementById("select-all-kampagnen");n&&(n.indeterminate=!1,n.checked=!0),this.updateSelection()}}),document.addEventListener("click",e=>{e.target.id==="btn-deselect-all"&&(e.preventDefault(),this.deselectAll())}),document.addEventListener("click",e=>{if(e.target.classList.contains("table-link")&&e.target.dataset.table==="kampagne"){e.preventDefault();const t=e.target.dataset.id;console.log("🎯 KAMPAGNELIST: Navigiere zu Kampagne Details:",t),window.navigateTo(`/kampagne/${t}`)}}),window.addEventListener("entityUpdated",e=>{e.detail.entity==="kampagne"&&this.loadAndRender()}),document.addEventListener("click",e=>{if(e.target.classList.contains("tag-x")){e.preventDefault(),e.stopPropagation();const n=e.target.closest(".filter-tag").dataset.key,a=y.getFilters("kampagne");delete a[n],y.applyFilters("kampagne",a),this.loadAndRender()}}),document.addEventListener("change",e=>{if(e.target.id==="select-all-kampagnen"){const t=document.querySelectorAll(".kampagne-check"),n=e.target.checked;t.forEach(a=>{a.checked=n,n?this.selectedKampagnen.add(a.dataset.id):this.selectedKampagnen.delete(a.dataset.id)}),this.updateSelection(),console.log(`${n?"✅ Alle Kampagnen ausgewählt":"❌ Alle Kampagnen abgewählt"}: ${this.selectedKampagnen.size}`)}}),document.addEventListener("change",e=>{e.target.classList.contains("kampagne-check")&&(e.target.checked?this.selectedKampagnen.add(e.target.dataset.id):this.selectedKampagnen.delete(e.target.dataset.id),this.updateSelection(),this.updateSelectAllCheckbox())}),window.bulkActionSystem&&window.bulkActionSystem.registerList("kampagne",this)}hasActiveFilters(){const e=y.getFilters("kampagne");return Object.keys(e).length>0}updateSelection(){const e=this.selectedKampagnen.size,t=document.getElementById("selected-count"),n=document.getElementById("btn-deselect-all"),a=document.getElementById("btn-delete-selected");t&&(t.textContent=`${e} ausgewählt`,t.style.display=e>0?"inline":"none"),n&&(n.style.display=e>0?"inline-block":"none"),a&&(a.style.display=e>0?"inline-block":"none")}async updateTable(e){const t=document.getElementById("kampagnen-table-body");if(!t)return;if(!e||e.length===0){const{renderEmptyState:a}=await C(async()=>{const{renderEmptyState:r}=await import("./core-C7Vz5Umf.js").then(i=>i.F);return{renderEmptyState:r}},[]);a(t);return}const n=e.map(a=>{const r=s=>s?new Date(s).toLocaleDateString("de-DE"):"-",i=s=>s&&Array.isArray(s)&&s.length?s.join(", "):"-";return`
        <tr data-id="${a.id}">
                  ...
                  <div class="submenu" data-submenu="status">
                    ${(this.statusOptions||[]).map(s=>`
                      <a href="#" class="submenu-item" data-action="set-field" data-field="status_id" data-value="${s.id}" data-status-name="${s.name}" data-id="${a.id}">
                        ${D.getStatusIcon(s.name)}
                        <span>${s.name}</span>
                        ${a.status_id&&a.status_id===s.id||a.status_name===s.name?'<span class="submenu-check">'+D.getHeroIcon("check")+"</span>":""}
                      </a>
                    `).join("")}
                  </div>
                </div>
...
`)}`)),alert(i),this.deselectAll(),await this.loadAndRender(),window.dispatchEvent(new CustomEvent("entityUpdated",{detail:{entity:"kampagne",action:"bulk-deleted",count:n}}))}renderAnsprechpartner(e){return!e||e.length===0?"-":`<div class="tags tags-compact">${e.filter(n=>n&&n.vorname&&n.nachname).map(n=>`<a href="#" class="tag tag--ansprechpartner" data-action="view-ansprechpartner" data-id="${n.id}" onclick="event.preventDefault(); window.navigateTo('/ansprechpartner/${n.id}')">${n.vorname} ${n.nachname}</a>`).join("")}</div>`}}const ge=new nt;class at{constructor(){this.kampagneId=null,this.kampagneData=null,this.creator=[],this.notizen=[],this.ratings=[],this.kooperationen=[],this.koopBudgetSum=0,this.koopVideosUsed=0,this.sourcingCreators=[],this.favoriten=[],this.rechnungen=[],this.history=[],this.historyCount=0,this.koopHistory=[],this.koopHistoryCount=0}async init(e){if(console.log("🎯 KAMPAGNEDETAIL: Initialisiere Kampagnen-Detailseite für ID:",e),this.kampagneId=e,window.moduleRegistry?.currentModule!==this){console.log("⚠️ KAMPAGNEDETAIL: Nicht mehr das aktuelle Modul, breche ab");return}try{await this.loadKampagneData(),await this.render(),this.bindEvents(),this.bindAnsprechpartnerEvents(),console.log("✅ KAMPAGNEDETAIL: Initialisierung abgeschlossen")}catch(t){console.error("❌ KAMPAGNEDETAIL: Fehler bei der Initialisierung:",t),window.ErrorHandler.handle(t,"KampagneDetail.init")}}async loadKooperationen(){try{const{data:e,error:t}=await window.supabase.from("kooperationen").select("id, name, status, gesamtkosten, videoanzahl, creator_id").eq("kampagne_id",this.kampagneId).order("created_at",{ascending:!1});if(t)throw t;const n=Array.from(new Set((e||[]).map(r=>r.creator_id).filter(Boolean)));let a={};if(n.length>0){const{data:r}=await window.supabase.from("creator").select("id, vorname, nachname").in("id",n);a=(r||[]).reduce((i,s)=>(i[s.id]=s,i),{})}this.kooperationen=(e||[]).map(r=>({...r,creator:a[r.creator_id]||null})),this.koopBudgetSum=this.kooperationen.reduce((r,i)=>r+(parseFloat(i.gesamtkosten)||0),0),this.koopVideosUsed=this.kooperationen.reduce((r,i)=>r+(parseInt(i.videoanzahl,10)||0),0),console.log("✅ KAMPAGNEDETAIL: Kooperationen geladen:",this.kooperationen.length,"Budgetsumme:",this.koopBudgetSum)}catch(e){console.error("❌ KAMPAGNEDETAIL: Fehler beim Laden der Kooperationen:",e),this.kooperationen=[],this.koopBudgetSum=0}}renderKooperationen(){const e=d=>d?new Intl.NumberFormat("de-DE",{style:"currency",currency:"EUR"}).format(d):"-",t=this.kampagneData?.auftrag?.creator_budget||0,n=this.koopBudgetSum,a=t>0?Math.min(100,Math.round(n/t*100)):0,r=this.kampagneData?.videoanzahl||0,i=this.koopVideosUsed||0,s=Math.max(0,r-i),o=r>0?Math.min(100,Math.round(i/r*100)):0,l=`
    ...
    `;window.setContentSafely(window.content,n)}async initializeFilterBar(){const e=document.getElementById("filter-container");e&&await y.renderFilterBar("briefing",e,t=>this.onFiltersApplied(t),()=>this.onFiltersReset())}onFiltersApplied(e){console.log("🔍 BriefingList: Filter angewendet:",e),y.applyFilters("briefing",e),this.loadAndRender()}onFiltersReset(){console.log("🔄 BriefingList: Filter zurückgesetzt"),y.resetFilters("briefing"),this.loadAndRender()}bindEvents(){this.boundFilterResetHandler=e=>{e.target.id==="btn-filter-reset"&&this.onFiltersReset()},document.addEventListener("click",this.boundFilterResetHandler),document.addEventListener("click",e=>{(e.target.id==="btn-briefing-new"||e.target.id==="btn-briefing-new-filter")&&(e.preventDefault(),window.navigateTo("/briefing/new"))}),document.addEventListener("click",e=>{if(e.target.id==="btn-select-all"){e.preventDefault(),document.querySelectorAll(".briefing-check").forEach(a=>{a.checked=!0,a.dataset.id&&this.selectedBriefings.add(a.dataset.id)});const n=document.getElementById("select-all-briefings");n&&(n.indeterminate=!1,n.checked=!0),this.updateSelection()}}),document.addEventListener("click",e=>{if(e.target.id==="btn-deselect-all"){e.preventDefault(),document.querySelectorAll(".briefing-check").forEach(a=>{a.checked=!1}),this.selectedBriefings.clear();const n=document.getElementById("select-all-briefings");n&&(n.indeterminate=!1,n.checked=!1),this.updateSelection()}}),document.addEventListener("click",e=>{if(e.target.classList.contains("table-link")&&e.target.dataset.table==="briefing"){e.preventDefault();const t=e.target.dataset.id;window.navigateTo(`/briefing/${t}`)}}),window.addEventListener("entityUpdated",e=>{e.detail.entity==="briefing"&&this.loadAndRender()}),document.addEventListener("change",e=>{if(e.target.id==="select-all-briefings"){const t=document.querySelectorAll(".briefing-check"),n=e.target.checked;t.forEach(a=>{a.checked=n,n?this.selectedBriefings.add(a.dataset.id):this.selectedBriefings.delete(a.dataset.id)}),this.updateSelection()}}),document.addEventListener("change",e=>{e.target.classList.contains("briefing-check")&&(e.target.checked?this.selectedBriefings.add(e.target.dataset.id):this.selectedBriefings.delete(e.target.dataset.id),this.updateSelection(),this.updateSelectAllCheckbox())})}hasActiveFilters(){const e=y.getFilters("briefing");return Object.keys(e).length>0}showDeleteSelectedConfirmation(){const e=this.selectedBriefings.size;if(e===0){alert("Keine Briefings ausgewählt.");return}const t=e===1?"Möchten Sie das ausgewählte Briefing wirklich löschen?":`Möchten Sie die ${e} ausgewählten Briefings wirklich löschen?`;confirm(`${t}
...
${a} Briefings konnten nicht gelöscht werden.`):alert(i),r.forEach(o=>{const l=document.querySelector(`tr[data-id="${o}"]`);l&&l.remove()}),this.selectedBriefings.clear(),this.updateSelection(),this.updateSelectAllCheckbox();const s=document.getElementById("briefings-table-body");s&&s.children.length===0&&await this.loadAndRender(),window.dispatchEvent(new CustomEvent("entityUpdated",{detail:{entity:"briefing",action:"bulk-deleted",count:n}}))}else alert("Keine Briefings konnten gelöscht werden.")}updateSelection(){const e=this.selectedBriefings.size,t=document.getElementById("btn-deselect-all"),n=document.getElementById("btn-delete-selected");t&&(t.style.display=e>0?"inline-block":"none"),n&&(n.style.display=e>0?"inline-block":"none")}updateSelectAllCheckbox(){const e=document.getElementById("select-all-briefings"),t=document.querySelectorAll(".briefing-check");if(!e||t.length===0)return;const n=Array.from(t).filter(r=>r.checked).length,a=t.length;e.checked=n===a,e.indeterminate=n>0&&n<a}async updateTable(e){const t=document.getElementById("briefings-table-body");if(!t)return;if(!e||e.length===0){const{renderEmptyState:i}=await C(async()=>{const{renderEmptyState:s}=await import("./core-C7Vz5Umf.js").then(o=>o.F);return{renderEmptyState:s}},[]);i(t);return}const n=i=>i?new Date(i).toLocaleDateString("de-DE"):"-",a=i=>window.validatorSystem.sanitizeHtml(i||"—"),r=e.map(i=>`
    ...
    `}destroy(){window.setContentSafely("")}}const ve=new ot;class lt{constructor(){this.formData={}}async init(){console.log("🎯 ANSPRECHPARTNERCREATE: Initialisiere Ansprechpartner-Erstellung"),this.showCreateForm()}showCreateForm(){console.log("🎯 ANSPRECHPARTNERCREATE: Zeige Ansprechpartner-Erstellungsformular mit FormSystem"),window.setHeadline("Neuen Ansprechpartner anlegen");const e=window.formSystem.renderFormOnly("ansprechpartner"),t=document.getElementById("dashboard-content");t.innerHTML=`
      <div class="page-header">
        <div class="page-header-left">
    ...
    `,window.formSystem.bindFormEvents("ansprechpartner",null);const n=document.getElementById("ansprechpartner-form");n&&(n.onsubmit=async a=>{a.preventDefault(),await this.handleFormSubmit()})}async handleFormSubmit(){let e="Ansprechpartner anlegen";try{console.log("🎯 ANSPRECHPARTNERCREATE: Verarbeite Formular-Submit");const t=document.querySelector('#ansprechpartner-form button[type="submit"]');t&&(e=t.innerHTML,t.innerHTML='<div class="loading-spinner"></div> Wird angelegt...',t.disabled=!0);const n=document.getElementById("ansprechpartner-form"),a=new FormData(n),r={},i={},s=n.querySelectorAll('select[data-tag-based="true"]');console.log("🏷️ Tag-basierte Selects gefunden:",s.length),s.forEach(c=>{let d=n.querySelector(`select[name="${c.name}"][style*="display: none"]`);if(!d){const u=n.querySelectorAll(`select[name="${c.name}"]`);u.length>1&&(d=u[1])}if(d){const u=Array.from(d.selectedOptions).map(h=>h.value).filter(h=>h!=="");u.length>0&&(i[c.name]=u,console.log(`🏷️ Tag-basiertes Multi-Select ${c.name}:`,u))}});for(let[c,d]of a.entries())if(!i.hasOwnProperty(c))if(c.includes("[]")){const u=c.replace("[]","");i[u]||(i[u]=[]),i[u].push(d)}else i[c]?(Array.isArray(i[c])||(i[c]=[i[c]]),i[c].push(d)):i[c]=d;for(let[c,d]of Object.entries(i))r[c]=Array.isArray(d)?d:d.trim();console.log("📤 Finale Ansprechpartner-Daten:",r);const o=window.validatorSystem.validateForm(r,{vorname:{type:"text",minLength:2,required:!0},nachname:{type:"text",minLength:2,required:!0}});if(!o.isValid){this.showValidationErrors(o.errors);return}const l=await window.dataService.createEntity("ansprechpartner",r);if(l.success)this.showSuccessMessage("Ansprechpartner erfolgreich erstellt!"),setTimeout(()=>{window.navigateTo("/ansprechpartner")},1500);else throw new Error(l.error||"Fehler beim Erstellen des Ansprechpartners")}catch(t){console.error("❌ Fehler beim Erstellen des Ansprechpartners:",t),this.showErrorMessage(t.message||"Ein unerwarteter Fehler ist aufgetreten")}finally{const t=document.querySelector('#ansprechpartner-form button[type="submit"]');t&&(t.innerHTML=e,t.disabled=!1)}}showValidationErrors(e){document.querySelectorAll(".field-error").forEach(t=>t.remove());for(const[t,n]of Object.entries(e)){const a=document.querySelector(`[name="${t}"]`);if(a){const r=document.createElement("div");r.className="field-error",r.textContent=n,r.style.color="red",r.style.fontSize="12px",r.style.marginTop="4px",a.parentNode.appendChild(r)}}}showSuccessMessage(e){const t=document.createElement("div");t.className="toast success",t.textContent=e,t.style.cssText=`
      position: fixed;
      top: 20px;
      right: 20px;
      background: #10b981;
...
${t}`)}showSuccessMessage(e){console.log(`✅ ${e}`)}showErrorMessage(e){console.error(`❌ ${e}`),alert(e)}}class ut{constructor(){this.ansprechpartner=null,this.ansprechpartnerId=null,this.formConfig=null,this.formRenderer=null,this.dataLoader=null,this.formSystem=null}async init(e){if(this.ansprechpartnerId=e,console.log("🎯 ANSPRECHPARTNERDETAIL: Initialisiere Detail-Seite für:",e),e==="new"){console.log("🎯 ANSPRECHPARTNERDETAIL: Verwende AnsprechpartnerCreate für neuen Ansprechpartner"),q.showCreateForm();return}else await this.loadAnsprechpartnerData(),this.render(),this.bindEvents()}async loadAnsprechpartnerData(){try{console.log("🔄 ANSPRECHPARTNERDETAIL: Lade Ansprechpartner-Daten...");const{data:e,error:t}=await window.supabase.from("ansprechpartner").select(`
    ...
    `;window.setContentSafely(window.content,e)}async initializeFilterBar(){const e=document.getElementById("filter-container");e&&await y.renderFilterBar("rechnung",e,t=>this.onFiltersApplied(t),()=>this.onFiltersReset())}onFiltersApplied(e){y.applyFilters("rechnung",e),this.loadAndRender()}onFiltersReset(){y.resetFilters("rechnung"),this.loadAndRender()}hasActiveFilters(){const e=y.getFilters("rechnung");return Object.keys(e).length>0}async updateTable(e){const t=document.getElementById("rechnungen-table-body");if(!t)return;if(!e||e.length===0){const{renderEmptyState:s}=await C(async()=>{const{renderEmptyState:o}=await import("./core-C7Vz5Umf.js").then(l=>l.F);return{renderEmptyState:o}},[]);s(t);return}const n=s=>s==null?"-":new Intl.NumberFormat("de-DE",{style:"currency",currency:"EUR"}).format(s),a=s=>s?new Intl.DateTimeFormat("de-DE").format(new Date(s)):"-",r=e.map(s=>`
      <tr data-id="${s.id}">
                ...
                <div class="submenu" data-submenu="status">
                  ${[{label:"Offen",icon:"status-offen"},{label:"Rückfrage",icon:"status-rueckfrage"},{label:"Bezahlt",icon:"status-bezahlt"},{label:"An Qonto gesendet",icon:"status-qonto"}].map(o=>`
                    <a href="#" class="submenu-item" data-action="set-field" data-field="status" data-value="${o.label}" data-id="${s.id}">
                      ${D.getHeroIcon(o.icon)}
                      <span>${o.label}</span>
                      ${s.status===o.label?'<span class="submenu-check">'+D.getHeroIcon("check")+"</span>":""}
                    </a>
                  `).join("")}
                </div>
              </div>
    ...
    `,window.formSystem.bindFormEvents("rechnung",null);const t=document.getElementById("rechnung-form");t&&(t.onsubmit=async n=>{n.preventDefault(),await this.handleCreateSubmit()})}async handleCreateSubmit(){try{const e=document.getElementById("rechnung-form"),t=new FormData(e),n={};for(const[o,l]of t.entries())n[o]=l;const a=e.querySelector('.uploader[data-name="pdf_file"]');let r=null,i=null;if(a&&a.__uploaderInstance&&a.__uploaderInstance.files.length&&window.supabase){const o=a.__uploaderInstance.files[0],l="rechnungen",c=`${n.unternehmen_id||"unknown"}/${Date.now()}_${o.name}`,{error:d}=await window.supabase.storage.from(l).upload(c,o,{cacheControl:"3600",upsert:!1,contentType:o.type});if(d)throw d;const{data:u}=window.supabase.storage.from(l).getPublicUrl(c);r=u.publicUrl,i=c}r&&(n.pdf_url=r,n.pdf_path=i);const s=await window.dataService.createEntity("rechnung",n);if(s.success){try{const o=e.querySelector('.uploader[data-name="belege_files"]');if(o&&o.__uploaderInstance&&o.__uploaderInstance.files.length&&window.supabase){const l=s.id,c=Array.from(o.__uploaderInstance.files);for(const d of c){const u="rechnung-belege",h=`${l}/${Date.now()}_${Math.random().toString(36).slice(2)}_${d.name}`,{error:m}=await window.supabase.storage.from(u).upload(h,d,{cacheControl:"3600",upsert:!1,contentType:d.type});if(m)throw m;const{data:g}=await window.supabase.storage.from(u).createSignedUrl(h,3600*24*7),b=g?.signedUrl||"";await window.supabase.from("rechnung_belege").insert({rechnung_id:l,file_name:d.name,file_path:h,file_url:b,content_type:d.type,size:d.size,uploaded_by:window.currentUser?.id||null})}}}catch(o){console.warn("⚠️ Belege-Upload teilweise fehlgeschlagen:",o)}alert("Rechnung erstellt"),window.navigateTo(`/rechnung/${s.id}`)}else throw new Error(s.error||"Unbekannter Fehler")}catch(e){alert(`Fehler: ${e.message}`)}}bindEvents(){document.addEventListener("click",e=>{e.target.id==="btn-edit-rechnung"&&this.showEditForm()})}showEditForm(){const e=window.formSystem.renderFormOnly("rechnung",this.data);window.content.innerHTML=`
      <div class="page-header">
        <div class="page-header-left">
      ...
      <div class="form-page">${e}</div>
    `,window.formSystem.bindFormEvents("rechnung",this.data)}}const gt=new pt;class bt{constructor(){this.rows=[]}async init(){if(window.setHeadline("Mitarbeiter"),!(window.currentUser?.rolle==="admin"||window.canViewPage?.("mitarbeiter")||window.checkUserPermission("dashboard","can_view"))){window.content.innerHTML=`
        <div class="error-message">
              ...
              <div class="action-submenu">
                ...
                <div class="submenu" data-submenu="status">
                  ${(this.statusOptions||[]).map(n=>`
                    <a href="#" class="submenu-item" data-action="set-field" data-field="status_id" data-value="${n.id}" data-status-name="${n.name.replace(/\"/g,'\\"')}" data-id="${t.id}">${D.getStatusIcon(n.name)}<span>${n.name}</span></a>
                  `).join("")}
                </div>
              </div>
...
`)}`)),alert(l),this.genericDeselectAll(),this.currentListInstance&&typeof this.currentListInstance.loadAndRender=="function"?await this.currentListInstance.loadAndRender():window.location.reload(),window.dispatchEvent(new CustomEvent("entityUpdated",{detail:{entity:e,action:"bulk-deleted",count:r}}))}detectCurrentEntityType(){const e=window.location.pathname.split("/").filter(n=>n);if(e.length>0){const n=e[0];if(["creator","unternehmen","kampagne","marke","auftrag","ansprechpartner","kooperation"].includes(n))return n}const t=["creator","unternehmen","kampagne","marke","auftrag","ansprechpartner","kooperation"];for(const n of t){const a=this.getEntityConfig(n);if(document.querySelectorAll(a.checkboxSelector).length>0)return console.log(`🔧 BulkActionSystem: Entity-Type ${n} aus Checkboxen erkannt`),n}return null}getEntityConfig(e){return{creator:{checkboxSelector:".creator-check",selectAllId:"select-all-creators",displayName:"Creator"},unternehmen:{checkboxSelector:".unternehmen-check",selectAllId:"select-all-unternehmen",displayName:"Unternehmen"},kampagne:{checkboxSelector:".kampagne-check",selectAllId:"select-all-kampagnen",displayName:"Kampagnen"},marke:{checkboxSelector:".marke-check",selectAllId:"select-all-marken",displayName:"Marken"},auftrag:{checkboxSelector:".auftrag-check",selectAllId:"select-all-auftraege",displayName:"Aufträge"},ansprechpartner:{checkboxSelector:".ansprechpartner-check",selectAllId:"select-all-ansprechpartner",displayName:"Ansprechpartner"},kooperation:{checkboxSelector:".kooperation-check",selectAllId:"select-all-kooperationen",displayName:"Kooperationen"}}[e]||{checkboxSelector:`.${e}-check`,selectAllId:`select-all-${e}`,displayName:e}}hideButtons(){const e=document.getElementById("selected-count"),t=document.getElementById("btn-deselect-all"),n=document.getElementById("btn-delete-selected");e&&(e.style.display="none"),t&&(t.style.display="none"),n&&(n.style.display="none")}destroy(){this.boundEventListeners.forEach(({element:e,type:t,handler:n})=>{e.removeEventListener(t,n)}),this.boundEventListeners.clear()}}const ye=new kt;class yt{constructor(){this.notifications=[],this.unreadCount=0,this.pollIntervalMs=6e4,this._timer=null,this._initialized=!1}init(){this._initialized||(this._initialized=!0,this.bindUI(),this.refresh(!0),this.startPolling(),window.addEventListener("notificationsRefresh",()=>this.refresh()))}destroy(){this._timer&&clearInterval(this._timer),this._timer=null,this._initialized=!1}startPolling(){this._timer&&clearInterval(this._timer),this._timer=setInterval(()=>this.refresh(),this.pollIntervalMs)}bindUI(){const e=document.querySelector("#notificationBell, .notification-bell"),t=document.querySelector("#notificationDropdown, .notification-dropdown");if(!e||!t)return;const n=()=>{t.classList.toggle("show")};e.addEventListener("click",a=>{a.preventDefault(),n()}),document.addEventListener("click",a=>{!t.contains(a.target)&&!e.contains(a.target)&&t.classList.remove("show")})}async refresh(e=!1){try{if(!window.supabase||!window.currentUser?.id)return;const{data:t,error:n}=await window.supabase.from("notifications").select("id, user_id, type, entity, entity_id, title, message, created_at, read_at").eq("user_id",window.currentUser.id).order("created_at",{ascending:!1}).limit(20);if(n)throw n;this.notifications=t||[],this.unreadCount=(this.notifications||[]).filter(a=>!a.read_at).length,this.renderBadge(),this.renderDropdown(),!e&&this.unreadCount>0}catch(t){console.warn("⚠️ Notifications refresh failed",t)}}renderBadge(){const e=document.querySelector("#notificationBadge, .notification-badge");if(!e)return;const t=this.unreadCount;e.textContent=t>99?"99+":String(t||""),e.style.display=t>0?"":"none"}renderDropdown(){const e=document.querySelector("#notificationDropdown, .notification-dropdown");if(!e)return;const t=(this.notifications||[]).map(a=>{const r=this.getEntityUrl(a.entity,a.entity_id),i=new Date(a.created_at).toLocaleString("de-DE");return`
    ...
    `;window.setContentSafely(window.content,t)}renderPendingMessage(){return`
      <div class="content-section">
        <div class="pending-user-message">
          <div class="pending-icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="pending-clock-icon">
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
            </svg>
          </div>
    ...
    `}getEntityLabel(e){return{creator:"Creator",kampagne:"Kampagnen",kooperation:"Kooperationen",briefing:"Briefings",rechnung:"Rechnungen",unternehmen:"Unternehmen",marke:"Marken",auftrag:"Aufträge",ansprechpartner:"Ansprechpartner"}[e]||e}bind(){const e=document.querySelectorAll(".tab-btn"),t=document.querySelectorAll(".tab-pane");e.forEach(n=>{n.addEventListener("click",()=>{const a=n.dataset.tab;e.forEach(r=>r.classList.remove("active")),t.forEach(r=>r.classList.remove("active")),n.classList.add("active"),document.getElementById(`tab-${a}`)?.classList.add("active")})}),document.getElementById("edit-profile-btn")?.addEventListener("click",()=>{this.isEditing=!this.isEditing,this.render()}),document.getElementById("save-profile-btn")?.addEventListener("click",async()=>{await this.saveProfile()}),document.getElementById("cancel-edit-btn")?.addEventListener("click",()=>{this.isEditing=!1,this.render()})}async saveProfile(){try{const t=document.getElementById("name-input")?.value?.trim();if(!t){alert("Name darf nicht leer sein");return}const{error:n}=await window.supabase.from("benutzer").update({name:t,updated_at:new Date().toISOString()}).eq("id",this.user.id);if(n)throw n;window.currentUser.name=t,this.user.name=t,window.setupHeaderUI?.(),this.isEditing=!1,await this.render(),alert("Profil erfolgreich aktualisiert"),console.log("✅ Profil gespeichert")}catch(e){console.error("❌ Fehler beim Speichern:",e),alert("Fehler beim Speichern des Profils")}}formatDate(e){return e?new Date(e).toLocaleDateString("de-DE",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"}):"Unbekannt"}destroy(){console.log("ProfileDetail: Cleaning up...")}}class $t{constructor(){this.modules=new Map,this.currentModule=null}register(e,t){this.modules.set(e,t)}navigateTo(e){const t=e.replace(/^\//,""),[n,a]=t.split("/");this.currentModule&&this.currentModule.destroy&&(console.log("🗑️ Zerstöre aktuelles Modul:",this.currentModule.constructor.name),this.currentModule.destroy(),this.currentModule=null);let r=n,i=this.modules.get(r);if(a&&n==="creator"&&a!=="new"&&(r="creator-detail",i=this.modules.get(r),console.log(`🎯 Creator-Details erkannt, verwende Modul: ${r}`)),n==="creator-lists"&&a&&(r="creator-list-detail",i=this.modules.get(r),console.log("🎯 Creator-Listen-Detail erkannt")),a&&n==="mitarbeiter"&&a!=="new"&&(r="mitarbeiter-detail",i=this.modules.get(r),console.log(`🎯 Mitarbeiter-Details erkannt, verwende Modul: ${r}`)),a&&n==="marke"&&a!=="new"&&(r="marke-detail",i=this.modules.get(r),console.log(`🎯 Marken-Details erkannt, verwende Modul: ${r}`)),a==="neu"&&n==="unternehmen"?(r="unternehmen-create",i=this.modules.get(r),console.log(`🎯 Unternehmen-Erstellung erkannt, verwende Modul: ${r}`)):a&&n==="unternehmen"&&a!=="new"&&a!=="neu"&&(r="unternehmen-detail",i=this.modules.get(r),console.log(`🎯 Unternehmen-Details erkannt, verwende Modul: ${r}`)),a&&n==="auftrag"&&a!=="new"&&(r="auftrag-detail",i=this.modules.get(r),console.log(`🎯 Auftrags-Details erkannt, verwende Modul: ${r}`)),a&&n==="kooperation"&&a!=="new"&&(r="kooperation-detail",i=this.modules.get(r),console.log(`🎯 Kooperations-Details erkannt, verwende Modul: ${r}`)),a&&n==="video"&&a!=="new"&&(r="kooperation-video-detail",i=this.modules.get(r),console.log(`🎯 Video-Details erkannt, verwende Modul: ${r}`)),a&&n==="kampagne"&&a!=="new"&&(r="kampagne-detail",i=this.modules.get(r),console.log(`🎯 Kampagnen-Details erkannt, verwende Modul: ${r}`)),a&&n==="briefing"&&a!=="new"&&(r="briefing-detail",i=this.modules.get(r),console.log(`🎯 Briefing-Details erkannt, verwende Modul: ${r}`)),a&&n==="rechnung"&&a!=="new"&&(r="rechnung-detail",i=this.modules.get(r),console.log(`🎯 Rechnung-Details erkannt, verwende Modul: ${r}`)),a&&n==="ansprechpartner"&&(r="ansprechpartner-detail",i=this.modules.get(r),console.log(`🎯 Ansprechpartner-Details/Erstellung erkannt, verwende Modul: ${r}`)),i)return console.log(`✅ Modul gefunden: ${r}`,i),this.currentModule=i,a==="new"?n==="rechnung"?(r="rechnung-detail",i=this.modules.get(r),i.init?.("new")):(console.log(`📝 Zeige Erstellungsformular für: ${n}`),r.includes("-detail")?i.init?.("new"):i.showCreateForm?.()):a?(console.log(`👁️ Zeige Details für: ${n}/${a}`),i.init?.(a)):(console.log(`🚀 Initialisiere Modul: ${n}`),i.init());console.warn(`❌ Modul nicht gefunden: ${r}`),this.loadDashboard()}loadDashboard(){const e=this.modules.get("dashboard");e?(this.currentModule=e,e.init()):(window.setHeadline("Dashboard"),window.content.innerHTML=`
        <div class="dashboard">
          <h1>Willkommen im CRM</h1>
          <p>Dashboard wird geladen...</p>
        </div>
      `)}}const S=new $t;window.moduleRegistry=S;S.register("creator",Z);S.register("creator-detail",W);S.register("creator-lists",ze);S.register("creator-list-detail",Be);S.register("unternehmen",Y);S.register("unternehmen-create",J);S.register("auftrag",Q);S.register("marke",X);S.register("marke-detail",ee);S.register("marke-create",U);S.register("unternehmen-detail",ce);S.register("auftrag-detail",ue);S.register("kooperation",he);S.register("kooperation-detail",me);S.register("kooperation-video-detail",pe);S.register("kampagne",ge);S.register("kampagne-detail",be);S.register("ansprechpartner",we);S.register("ansprechpartner-detail",ke);S.register("ansprechpartner-create",q);S.register("briefing",fe);S.register("briefing-detail",ve);S.register("rechnung",mt);S.register("rechnung-detail",gt);S.register("mitarbeiter",ft);S.register("mitarbeiter-detail",wt);S.register("dashboard",Ee);const $e=new Et;window.profileDetail=$e;S.register("profile",$e);window.navigateTo=p=>{S.navigateTo(p)};window.filterSystem=y;window.creatorList=Z;window.creatorDetail=W;window.unternehmenList=Y;window.unternehmenCreate=J;window.auftragList=Q;window.markeList=X;window.markeDetail=ee;window.markeCreate=U;window.unternehmenDetail=ce;window.auftragDetail=ue;window.kooperationList=he;window.kooperationDetail=me;window.kooperationVideoDetail=pe;window.kampagneList=ge;window.kampagneDetail=be;window.briefingDetail=ve;window.kampagneUtils=it;window.briefingList=fe;window.AuthService=K;window.AuthUtils=H;window.authService=K;window.authUtils=H;window.navigationSystem=te;window.permissionSystem=Se;window.dataService=x;window.validatorSystem=T;window.creatorUtils=ae;window.formSystem=de;window.notizenSystem=We;window.bewertungsSystem=Je;window.ActionsDropdown=D;window.bulkActionSystem=ye;window.notificationSystem=_e;window.ansprechpartnerList=we;window.ansprechpartnerDetail=ke;window.ansprechpartnerCreate=q;window.dashboardModule=Ee;window.SafeHTML=G;window.DOMHelper=M;window.setHeadline=function(p){const e=document.querySelector(".main-header h1");e&&(e.textContent=p)};window.setContentSafely=function(p,e){p&&e&&(window.SafeHTML?window.SafeHTML.setContent(p,e):p.textContent=e)};window.setTextSafely=function(p,e){p&&e&&(p.textContent=e)};document.addEventListener("DOMContentLoaded",async()=>{if(console.log("🎯 Initialisiere Event-basiertes Modul-System..."),window.appRoot=document.getElementById("app-root"),window.loginRoot=document.getElementById("login-root"),window.content=document.getElementById("dashboard-content"),window.nav=document.getElementById("main-nav"),window.supabase&&window.CONFIG?.SUPABASE?.URL&&window.CONFIG?.SUPABASE?.KEY)try{window.supabase=window.supabase.createClient(window.CONFIG.SUPABASE.URL,window.CONFIG.SUPABASE.KEY),console.log("✅ Supabase initialisiert")}catch(e){console.error("❌ Supabase-Initialisierung fehlgeschlagen:",e)}else console.warn("⚠️ Supabase nicht verfügbar - verwende Offline-Modus");if(await K.checkAuth()){console.log("✅ Benutzer ist authentifiziert"),te.init(),D.init(),ye.init(),_e.init(),M.show(window.appRoot),M.hide(window.loginRoot);const e=location.pathname;e==="/"||e==="/dashboard"?S.loadDashboard():S.navigateTo(e),window.setupHeaderUI?.()}else console.log("🔐 Benutzer nicht authentifiziert - zeige Login"),H.showLogin()});window.handleLogout=async()=>{try{await K.signOut()}catch(p){console.warn("Logout warn:",p)}finally{M.hide(window.appRoot),M.show(window.loginRoot);const p=document.getElementById("mitarbeiterPanelOverlay"),e=document.getElementById("mitarbeiterPanel");M.hide(p),M.hide(e),H.showLogin?.()}};window.setupHeaderUI=()=>{try{const p=document.querySelector(".profile-img"),e=document.querySelector(".profile-initials"),t=(window.currentUser?.name||"").trim();if(t&&e){const s=t.split(/\s+/).filter(Boolean),o=(s[0]?.[0]||"").toUpperCase()+(s[1]?.[0]||"").toUpperCase();e.textContent=o||(t[0]||"?").toUpperCase()}window.currentUser?.avatar_url&&p&&(p.src=window.currentUser.avatar_url,M.show(p),M.hide(e));const n=document.querySelector(".profile-btn"),a=document.querySelector(".profile-dropdown");n&&a&&!n.dataset.bound&&(n.dataset.bound="true",n.addEventListener("click",s=>{s.stopPropagation();const o=a.getAttribute("aria-hidden")==="false";a.setAttribute("aria-hidden",o?"true":"false"),n.setAttribute("aria-expanded",o?"false":"true")}),a.addEventListener("click",s=>{const o=s.target.closest("[data-action]")?.dataset.action;o&&(s.preventDefault(),a.setAttribute("aria-hidden","true"),n.setAttribute("aria-expanded","false"),o==="view-profile"&&S.navigateTo("/profile"))}),document.addEventListener("click",()=>{a.setAttribute("aria-hidden","true"),n.setAttribute("aria-expanded","false")}));const r=document.querySelector(".quick-menu-btn"),i=document.querySelector(".quick-menu-dropdown");if(r&&i&&!r.dataset.bound){const s=()=>{i.classList.remove("show"),r.setAttribute("aria-expanded","false")};r.addEventListener("click",l=>{l.preventDefault();const c=i.classList.toggle("show");r.setAttribute("aria-expanded",String(c))}),document.addEventListener("click",l=>{!i.contains(l.target)&&!r.contains(l.target)&&s()});const o={unternehmen:"unternehmen",marke:"marke",auftrag:"auftrag",ansprechpartner:"ansprechpartner",kampagne:"kampagne",briefing:"briefing",kooperation:"kooperation",creator:"creator"};i.querySelectorAll(".quick-menu-item").forEach(l=>{const c=l.getAttribute("data-entity"),d=o[c],u=d?!!window.permissionSystem?.getEntityPermissions(d)?.can_edit:!1;M.setVisibility(l,u||window.currentUser?.rolle==="admin")}),i.addEventListener("click",l=>{const c=l.target.closest(".quick-menu-item");if(!c)return;const d=c.getAttribute("data-entity");if(d){switch(d){case"unternehmen":window.navigateTo("/unternehmen/neu");break;case"marke":window.navigateTo("/marke/new");break;case"auftrag":window.navigateTo("/auftrag/new");break;case"ansprechpartner":window.navigateTo("/ansprechpartner/new");break;case"kampagne":window.navigateTo("/kampagne/new");break;case"briefing":window.navigateTo("/briefing/new");break;case"kooperation":window.navigateTo("/kooperation/new");break;case"creator":window.navigateTo("/creator/new");break}s()}}),r.dataset.bound="true"}}catch(p){console.warn("Header/Quick-Menu setup warn:",p)}};
