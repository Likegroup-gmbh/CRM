async function f(n,a,t,e,i){if(!n||!i)return;const r=Array.isArray(n)?n:n.filters||[],c=(await y(r)).map(s=>{const d=a[s.id];return v(s,d)}).join("");Object.keys(a).length>0&&Object.values(a).some(s=>s&&(Array.isArray(s)?s.length>0:s!==""));const o=`
    <div class="filter-section">
      <div class="filter-row">
        ${c}
      </div>
    </div>
  `;i.innerHTML=o,h(t,e)}function g(n){if(!n)return;const a=n.tagName==="TBODY"?n:null,t=`
