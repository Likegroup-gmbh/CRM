...
import '../assets/styles/dropdowns.css';
import '../assets/styles/badges-tags.css';
import '../assets/styles/tables.css';
import '../assets/styles/cards.css';
import '../assets/styles/modals-drawers.css';
import '../assets/styles/domain-video.css';
import '../assets/styles/domain-feedback.css';
import '../assets/styles/domain-profile.css';
import '../assets/styles/domain-calendar.css';
...
import { contractList } from './modules/contracts/ContractList.js';
...
import { briefingCreate } from './modules/briefing/create/BriefingCreate.js';
import { ansprechpartnerList, managementAnsprechpartnerList } from './modules/ansprechpartner/AnsprechpartnerList.js';
import { ansprechpartnerDetail } from './modules/ansprechpartner/AnsprechpartnerDetail.js';
import { ansprechpartnerCreate, managementAnsprechpartnerCreate } from './modules/ansprechpartner/AnsprechpartnerCreate.js';
...
window.moduleRegistry = moduleRegistry;
  ...
  moduleRegistry.register('management-creator', managementCreatorList);
  ...
  moduleRegistry.register('contracts', contractList);
  moduleRegistry.register('contracts-detail', contractDetail);
  ...
  moduleRegistry.register('management-ansprechpartner', managementAnsprechpartnerList);
  moduleRegistry.register('management-ansprechpartner-create', managementAnsprechpartnerCreate);
  ...
  moduleRegistry.register('briefing-create', briefingCreate);
