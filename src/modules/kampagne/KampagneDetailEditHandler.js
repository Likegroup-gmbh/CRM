...
export function showEditForm(detail) {
  ...
  if (form) {
    ...
    const editModeData = {
      ...
      ugc_paid_video_anzahl: detail.kampagneData.ugc_paid_video_anzahl,
      ugc_paid_creator_anzahl: detail.kampagneData.ugc_paid_creator_anzahl,
      ugc_organic_video_anzahl: detail.kampagneData.ugc_organic_video_anzahl || detail.kampagneData.ugc_video_anzahl || detail.kampagneData.igc_video_anzahl || 0,
      ugc_organic_creator_anzahl: detail.kampagneData.ugc_organic_creator_anzahl || detail.kampagneData.ugc_creator_anzahl || detail.kampagneData.igc_creator_anzahl || 0,
