...
// Fallback-Kette: 1. Creator-Lieferadresse, 2. Management-Adresse, 3. null
    ...
    if (resolved.source === 'management') {
      ...
      return `
        <div class="contract-address-fallback">
          <div class="contract-address-fallback__title">Creator hat keine eigene Adresse. Fuer den Vertrag wird die Management-Adresse verwendet.</div>
