// PersonaFilterLogic.js
// Supabase-Filter für die Personas-Liste. marke_id läuft über persona_marke
// und wird in PersonaList.loadPageData aufgelöst.

export class PersonaFilterLogic {
...
export default PersonaFilterLogic;
