...
export function renderTabNavigation(detail) {
  const tabs = [
    ...
    { tab: 'strategien', label: 'Konzepte', count: detail.strategien.length, isActive: detail.activeMainTab === 'strategien' },
    { tab: 'sourcing', label: 'Castings', count: detail.creatorAuswahlen.length, isActive: detail.activeMainTab === 'sourcing' },
